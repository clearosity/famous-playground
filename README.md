#playground
> Impactions.io playground.

[![Build Status](https://travis-ci.org/chalaschek/playground.svg?branch=master)](https://travis-ci.org/chalaschek/playground) [![Dependency Status](https://david-dm.org/chalaschek/playground.svg)](https://david-dm.org/chalaschek/playground) [![devDependency Status](https://david-dm.org/chalaschek/playground/dev-status.svg)](https://david-dm.org/chalaschek/playground#info=devDependencies)
...
## Release History
 * 2014-06-20   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)